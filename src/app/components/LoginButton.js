...
const LoginButton = (props) => {
  ...
  const scope = encodeURIComponent('user-read-email user-top-read playlist-modify-public user-read-currently-playing user-read-recently-played user-read-playback-state');
